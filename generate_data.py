...
def randint(a, b):
    ...
    # 生成一个8位随机数
    random_digit = random.randint(10000000, 99999999)
    return random_digit % b + 1
...
if __name__ == "__main__":
    ...
    for i in range(100):
        ...
        answer = get_chatgpt_answer(prompt, question, i)
        ...
        remaining_time = 10 - (end_time - start_time)  # 计算剩余时间
